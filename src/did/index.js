...
exports.getEndpointDid = async function(config) {
    if(!endpointDid) {
        ...
        if(!endpointDid) {
            await exports.createEndpointDid(config);
        }
    }
    return endpointDid;
};

exports.createEndpointDid = async function (config) {
    await setupSteward(config);
    ...
    await issueGovernmentIdCredential(config);
};
...
async function setupSteward(config) {
...
async function issueGovernmentIdCredential(config) {
