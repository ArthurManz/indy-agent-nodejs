...
router.post('/credentials/accept_offer', auth.isLoggedIn, async function(req, res) {
    let message = indy.store.messages.get(req.body.messageId);
    indy.store.messages.delete(req.body.messageId);
...
router.put('/connections/request', auth.isLoggedIn, async function (req, res) {
    ...
    let message = indy.store.messages.get(messageId);
    indy.store.messages.delete(messageId);
